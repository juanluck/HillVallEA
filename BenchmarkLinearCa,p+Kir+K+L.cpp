...
{
class multimodal_BenchmarkLinearCa,p+Kir+K+L_t : public fitness_t
{
	public:

	multimodal_BenchmarkLinearCa,p+Kir+K+L_t()
	{
	...
	std::string name() const { return "MultimodlBenchmarkLinearCa,p+Kir+K+L"; }
};
}
...
int main(int argc, char **argv)
{
  ...
  //-----------------------------------------
  hillvallea::fitness_pt fitness_function = std::make_shared<hillvallea::multimodal_BenchmarkLinearCa,p+Kir+K+L_t>();
