...
all: example_cec2013_benchmark example_simple multimodal_AIY multimodal_AFD multimodal_RIM
...
clean_run:
	rm -f example_cec2013_benchmark example_simple multimodal_AIY multimodal_AFD multimodal_RIM elites*.dat statistics*.dat 
