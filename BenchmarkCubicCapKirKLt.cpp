...
{
class BenchmarkCubicCapKirKLt : public fitness_t
{
	public:

	BenchmarkCubicCapKirKLt()
	{
...
int main(int argc, char **argv)
{
  ...
  //-----------------------------------------
  hillvallea::fitness_pt fitness_function = std::make_shared<hillvallea::BenchmarkCubicCapKirKLt>();
  ...
  std::string file_appendix = "BenchmarkCubicCapKirKLt_seed_"+std::to_string(random_seed); // can be used when multiple runs are outputted in the same directory
